...
export async function initCommand() {
    ...
    const answers = await inquirer.prompt([
        ...
        },
        {
            ...
            default: (ans) => ans.workspaceName.toLowerCase().replace(/[^a-z0-9]+/g, '-'),
        ...
        },
        {
            ...
            validate: (v) => v.startsWith('postgresql://') || 'Must be a valid PostgreSQL URL',
        },
        {
            type: 'input',
            name: 'adminEmail',
    ...
    if (!fs.existsSync(envPath)) {
        ...
        if (fs.existsSync(envExample)) {
            ...
            env = env.replace('postgresql://helpnest:helpnest@localhost:5432/helpnest_dev', answers.dbUrl);
