  ...
  return `
    <div class="hn-view hn-view-chat">
      <div class="hn-chat-header">
        ...
        <div class="hn-header-more-wrap">
          <button class="hn-header-more" type="button" aria-label="More options">
            <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor"><circle cx="5" cy="12" r="2"/><circle cx="12" cy="12" r="2"/><circle cx="19" cy="12" r="2"/></svg>
          </button>
          <div class="hn-header-more-menu">
            <button class="hn-more-menu-btn hn-expand-btn" type="button">
              <svg class="hn-icon-expand" width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M8 3H5a2 2 0 0 0-2 2v3m18 0V5a2 2 0 0 0-2-2h-3m0 18h3a2 2 0 0 0 2-2v-3M3 16v3a2 2 0 0 0 2 2h3"/></svg>
              <svg class="hn-icon-compress" width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M8 3v3a2 2 0 0 1-2 2H3m18 0h-3a2 2 0 0 1-2-2V3m0 18v-3a2 2 0 0 1 2-2h3M3 16h3a2 2 0 0 1 2 2v3"/></svg>
              <span class="hn-expand-label">Expand window</span>
              <span class="hn-compress-label">Compress window</span>
            </button>
          </div>
        </div>
...
export function bindChatEvents(container: HTMLElement, rerenderFn: () => void): void {
  ...
  // "..." overflow menu
  const moreBtn = container.querySelector('.hn-header-more') as HTMLButtonElement | null
  const moreMenu = container.querySelector('.hn-header-more-menu') as HTMLElement | null
  moreBtn?.addEventListener('click', (e) => {
    e.stopPropagation()
    moreMenu?.classList.toggle('hn-open')
  })
  container.addEventListener('click', () => moreMenu?.classList.remove('hn-open'))

  container.querySelector('.hn-expand-btn')?.addEventListener('click', () => {
    moreMenu?.classList.remove('hn-open')
