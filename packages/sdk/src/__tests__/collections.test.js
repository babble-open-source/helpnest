...
describe('HelpNest SDK — Collections', () => {
    ...
    it('creates a collection', async () => {
        ...
        expect(mockFetch).toHaveBeenCalledWith(expect.anything(), expect.objectContaining({ method: 'POST' }));
    });
    it('updates a collection', async () => {
        ...
        expect(mockFetch).toHaveBeenCalledWith(expect.stringContaining('/api/collections/1'), expect.objectContaining({ method: 'PATCH' }));
    });
