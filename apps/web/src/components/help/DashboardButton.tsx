  ...
  return (
    <div className="flex items-center gap-2">
      <a
        ...
        className="flex items-center gap-1.5 text-sm font-medium text-ink border border-border rounded-lg px-3 py-1.5 bg-white hover:bg-cream transition-colors"
      >
