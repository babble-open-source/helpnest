...
export default async function DashboardPage() {
  ...
  return (
    <div className="p-4 sm:p-8">
      <div className="mb-8">
        <h1 className="font-semibold text-2xl text-foreground">{t('overview')}</h1>
      ...
      {totalConversations > 0 && (
        <div className="grid grid-cols-2 lg:grid-cols-5 gap-4 mb-10">
          {[
            ...
            { label: t('escalationRate'), value: escalationRate !== null ? `${escalationRate}%` : '—', color: 'text-destructive' },
      ...
      {(aiNewDraftCount > 0 || aiUpdateCount > 0) && (
        <div className="flex flex-wrap gap-4 mb-10">
          {aiNewDraftCount > 0 && (
            <Link href="/articles?filter=ai-drafts">
          ...
          {aiUpdateCount > 0 && (
            <Link href="/articles?filter=ai-updates">
              <Card className="hover:border-primary transition-colors cursor-pointer">
                <CardContent className="p-5">
      ...
      <div className="mb-10">
        <h2 className="font-semibold text-base text-foreground mb-4">{t('needsAttention')}</h2>
        <Card>
                ...
                <div key={article.id}>
                  ...
                  <div className="flex items-center gap-4 p-4">
                    ...
                    <div className="text-end shrink-0">
                      <p className={`text-sm font-medium ${(article.helpfulRate ?? 0) >= 70 ? 'text-foreground' : 'text-destructive'}`}>
      ...
      {/* Recent articles */}
      <div>
        <h2 className="font-semibold text-base text-foreground mb-4">{t('recentArticles')}</h2>
        <Card>
          {recentArticles.length === 0 ? (
            <CardContent className="p-6 text-center">
              ...
              <Button variant="link" asChild className="mt-3 h-auto p-0">
