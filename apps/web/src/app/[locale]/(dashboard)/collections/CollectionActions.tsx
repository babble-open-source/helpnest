      ...
      <div className="flex flex-col items-end gap-1">
        <div className="flex items-center gap-3">
          <Button
            ...
            size="sm"
            onClick={openEdit}
            className="h-auto py-0 px-0 text-xs text-muted-foreground hover:text-primary hover:bg-transparent"
          >
            {t('edit')}
          </Button>
          <Button
              ...
              <div className="flex flex-wrap gap-2">
                {EMOJI_OPTIONS.map((e) => (
                  <Button
                    key={e}
                    type="button"
                    variant={emoji === e ? 'default' : 'secondary'}
                    size="icon"
                    onClick={() => setEmoji(e)}
                    className={cn(
                      'w-9 h-9 rounded-lg text-lg',
                      emoji !== e && 'hover:bg-muted/80'
                    )}
                  >
                    {e}
                  </Button>
