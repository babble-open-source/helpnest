  ...
  return (
    <div className="p-4 sm:p-8 max-w-2xl mx-auto">
      ...
      <div className="space-y-6">
        ...
        <Card>
          <CardHeader>
            <CardTitle className="text-sm font-medium">{t('yourProfile')}</CardTitle>
          </CardHeader>
          <CardContent>
        ...
        {isAdmin && (
          <>
            <Card>
              <CardHeader>
                <CardTitle className="text-sm font-medium">{t('workspace')}</CardTitle>
              </CardHeader>
              <CardContent>
                <WorkspaceForm
                  name={workspace?.name ?? ''}
            ...
            <Card>
              <CardHeader>
                <CardTitle className="text-sm font-medium">{t('branding')}</CardTitle>
