...
const BULK_ACTIONS: { action: BulkAction; label: string; danger?: boolean }[] = [
  ...
  { action: 'draft', label: 'Set to Draft' },
          ...
          >
            <div className="p-6">
              ...
              <p className="text-sm text-muted">
                ...
                <strong className="text-ink">{selected.size} article{selected.size !== 1 ? 's' : ''}</strong>{' '}
                and all their version history. This cannot be undone.
              </p>
