...
export default async function ConversationPage({ params, }) {
    ...
    return (<div className="flex flex-col lg:flex-row h-full">
      <ConversationDetail conversation={serializedConv} members={serializedMembers} currentMemberId={member.id}/>
    </div>);
}
