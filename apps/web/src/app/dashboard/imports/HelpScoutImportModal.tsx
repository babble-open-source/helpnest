    ...
    >
      ...
      >
        <div className="flex items-center justify-between px-6 py-4 border-b border-border">
          <h2 className="font-medium text-ink">Import from Help Scout</h2>
          <button
            onClick={onClose}
        ...
        {step === 'importing' && (
          <div className="p-6 flex flex-col items-center gap-4 py-10">
            ...
            <p className="text-sm text-ink font-medium">Importing from Help Scout…</p>
            <p className="text-xs text-muted text-center">
              Authenticating and fetching Docs collections. This may take a moment.
            </p>
          </div>
        )}
