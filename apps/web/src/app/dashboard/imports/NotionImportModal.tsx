    ...
    >
      ...
      >
        <div className="flex items-center justify-between px-6 py-4 border-b border-border">
          <h2 className="font-medium text-ink">Import from Notion</h2>
          <button
            onClick={onClose}
          ...
          <form onSubmit={handleSubmit} className="p-6 space-y-4">
            <div>
              <label className="block text-xs font-medium text-muted uppercase tracking-wide mb-1.5">
                Integration Token <span className="text-accent">*</span>
              </label>
              <input
                type="password"
                value={token}
            ...
            <div>
              <label className="block text-xs font-medium text-muted uppercase tracking-wide mb-1.5">
                Database ID <span className="text-muted normal-case font-normal">(optional)</span>
              </label>
              <input
                type="text"
                value={databaseId}
        ...
        {step === 'importing' && (
          <div className="p-6 flex flex-col items-center gap-4 py-10">
            ...
            <p className="text-sm text-ink font-medium">Importing from Notion…</p>
            <p className="text-xs text-muted text-center">
              Fetching pages and building collections. This may take a moment.
            </p>
          </div>
        )}
