    ...
    >
      ...
      >
        <div className="flex items-center justify-between px-6 py-4 border-b border-border">
          <h2 className="font-medium text-ink">Import from Zendesk</h2>
          <button
            onClick={onClose}
        ...
        {step === 'form' && (
          <form onSubmit={handleSubmit} className="p-6 space-y-4">
            ...
            <div>
              <label className="block text-xs font-medium text-muted uppercase tracking-wide mb-1.5">
                API Token <span className="text-accent">*</span>
              </label>
              <input
                type="password"
                value={apiToken}
            ...
            <div className="flex items-center justify-end gap-3 pt-2">
              ...
              <button
                type="submit"
                disabled={!subdomain.trim() || !email.trim() || !apiToken.trim()}
        ...
        {step === 'importing' && (
          <div className="p-6 flex flex-col items-center gap-4 py-10">
            ...
            <p className="text-sm text-ink font-medium">Importing from Zendesk…</p>
            <p className="text-xs text-muted text-center">
              Fetching sections and articles. This may take a moment.
            </p>
          </div>
        )}
