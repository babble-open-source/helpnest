...
export default async function AskAIPage(props) {
    ...
    const brandTextRecord = brandTextColumnExists
        ...
        : null;
    return (<div className="h-[100dvh] bg-cream flex flex-col">
      {/* Nav */}
      <nav className="shrink-0 bg-cream/95 backdrop-blur border-b border-border">
        <div className="max-w-2xl mx-auto px-4 h-14 flex items-center justify-between gap-2">
          ...
          <div className="flex items-center gap-2 sm:hidden min-w-0">
            <Link href={`/${params.workspace}/help`} className="p-1.5 -ml-1.5 rounded-lg text-muted hover:text-ink hover:bg-border/40 transition-colors shrink-0" aria-label="Back to help center">
